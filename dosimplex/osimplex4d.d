...
@nogc @safe pure double osNoise4D(double x, double y, double z, double w, const ref short[256] perm) {
    ...
    if (inSum <= 1) { //We're inside the pentachoron (4-Simplex) at (0,0,0,0)
        ...
        if (attn0 > 0) {
            attn0 *= attn0;
            value += attn0 * attn0 * extrapolate(xsb + 0, ysb + 0, zsb + 0, wsb + 0, dx0, dy0, dz0, dw0, perm);
        }
        ...
        if (attn1 > 0) {
            attn1 *= attn1;
            value += attn1 * attn1 * extrapolate(xsb + 1, ysb + 0, zsb + 0, wsb + 0, dx1, dy1, dz1, dw1, perm);
        }
        ...
        if (attn2 > 0) {
            attn2 *= attn2;
            value += attn2 * attn2 * extrapolate(xsb + 0, ysb + 1, zsb + 0, wsb + 0, dx2, dy2, dz2, dw2, perm);
        }
        ...
        if (attn3 > 0) {
            attn3 *= attn3;
            value += attn3 * attn3 * extrapolate(xsb + 0, ysb + 0, zsb + 1, wsb + 0, dx3, dy3, dz3, dw3, perm);
        }
        ...
        if (attn4 > 0) {
            attn4 *= attn4;
            value += attn4 * attn4 * extrapolate(xsb + 0, ysb + 0, zsb + 0, wsb + 1, dx4, dy4, dz4, dw4, perm);
        }
        ...
        if (attn4 > 0) {
            attn4 *= attn4;
            value += attn4 * attn4 * extrapolate(xsb + 1, ysb + 1, zsb + 1, wsb + 0, dx4, dy4, dz4, dw4, perm);
        }
        ...
        if (attn3 > 0) {
            attn3 *= attn3;
            value += attn3 * attn3 * extrapolate(xsb + 1, ysb + 1, zsb + 0, wsb + 1, dx3, dy3, dz3, dw3, perm);
        }
        ...
        if (attn2 > 0) {
            attn2 *= attn2;
            value += attn2 * attn2 * extrapolate(xsb + 1, ysb + 0, zsb + 1, wsb + 1, dx2, dy2, dz2, dw2, perm);
        }
        ...
        if (attn1 > 0) {
            attn1 *= attn1;
            value += attn1 * attn1 * extrapolate(xsb + 0, ysb + 1, zsb + 1, wsb + 1, dx1, dy1, dz1, dw1, perm);
        }
        ...
        if (attn0 > 0) {
            attn0 *= attn0;
            value += attn0 * attn0 * extrapolate(xsb + 1, ysb + 1, zsb + 1, wsb + 1, dx0, dy0, dz0, dw0, perm);
        }
        ...
        if (attn5 > 0) {
            attn5 *= attn5;
            value += attn5 * attn5 * extrapolate(xsb + 1, ysb + 1, zsb + 0, wsb + 0, dx5, dy5, dz5, dw5, perm);
        }
        ...
        if (attn6 > 0) {
            attn6 *= attn6;
            value += attn6 * attn6 * extrapolate(xsb + 1, ysb + 0, zsb + 1, wsb + 0, dx6, dy6, dz6, dw6, perm);
        }
        ...
        if (attn7 > 0) {
            attn7 *= attn7;
            value += attn7 * attn7 * extrapolate(xsb + 1, ysb + 0, zsb + 0, wsb + 1, dx7, dy7, dz7, dw7, perm);
        }
        ...
        if (attn8 > 0) {
            attn8 *= attn8;
            value += attn8 * attn8 * extrapolate(xsb + 0, ysb + 1, zsb + 1, wsb + 0, dx8, dy8, dz8, dw8, perm);
        }
        ...
        if (attn9 > 0) {
            attn9 *= attn9;
            value += attn9 * attn9 * extrapolate(xsb + 0, ysb + 1, zsb + 0, wsb + 1, dx9, dy9, dz9, dw9, perm);
        }
        ...
        if (attn10 > 0) {
            attn10 *= attn10;
            value += attn10 * attn10 * extrapolate(xsb + 0, ysb + 0, zsb + 1, wsb + 1, dx10, dy10, dz10, dw10, perm);
        }
    ...
    {
        attn_ext0 *= attn_ext0;
        value += attn_ext0 * attn_ext0 * extrapolate(xsv_ext0, ysv_ext0, zsv_ext0, wsv_ext0, dx_ext0, dy_ext0, dz_ext0, dw_ext0, perm);
    }
    ...
    {
        attn_ext1 *= attn_ext1;
        value += attn_ext1 * attn_ext1 * extrapolate(xsv_ext1, ysv_ext1, zsv_ext1, wsv_ext1, dx_ext1, dy_ext1, dz_ext1, dw_ext1, perm);
    }
    ...
    {
        attn_ext2 *= attn_ext2;
        value += attn_ext2 * attn_ext2 * extrapolate(xsv_ext2, ysv_ext2, zsv_ext2, wsv_ext2, dx_ext2, dy_ext2, dz_ext2, dw_ext2, perm);
    }
...
/**
    extrapolates for 4D
*/
private @nogc @safe pure double extrapolate(int xsb, int ysb, int zsb, int wsb, double dx, double dy, double dz, double dw, const ref short[256] perm)
{
    int index = perm[(perm[(perm[(perm[xsb & 0xFF] + ysb) & 0xFF] + zsb) & 0xFF] + wsb) & 0xFF] & 0xFC;
    return GRADIENTS.GRADIENTS_4D[index] * dx
        + GRADIENTS.GRADIENTS_4D[index + 1] * dy
        + GRADIENTS.GRADIENTS_4D[index + 2] * dz
        + GRADIENTS.GRADIENTS_4D[index + 3] * dw;
}